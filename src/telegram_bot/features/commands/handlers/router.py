...
# TODO: Реализовать keyboards
# from src.telegram_bot.resources.keyboards.reply_kb import RESTART_BUTTON_TEXT, SETTINGS_BUTTON_TEXT
RESTART_BUTTON_TEXT = "Restart"
SETTINGS_BUTTON_TEXT = "Settings"

from src.telegram_bot.core.container import BotContainer
# from src.telegram_bot.features.commands.logic.orchestrator import StartBotOrchestrator # TODO: Реализовать orchestrator
# from src.telegram_bot.features.commands.logic.ui.ui import StartUI # TODO: Реализовать UI
# from src.telegram_bot.resources.formatters import MessageInfoFormatter # TODO: Реализовать formatters
...
async def cmd_start(m: Message, state: FSMContext, bot: Bot, container: BotContainer) -> None:
    ...
    # 3. LOGIC
    # TODO: Раскомментировать, когда будет реализован оркестратор
    # ui_service = StartUI()
    # orchestrator = StartBotOrchestrator(None, ui_service, m.from_user)
    ...
    await m.answer("Bot is under construction 🚧")
...
async def cmd_get_data_message(m: Message) -> None:
    ...
    await m.answer("Debug info placeholder")
...
async def cmd_get_ids(m: Message) -> None:
    ...
    # await m.answer(formatted_info, parse_mode="HTML")
    await m.answer(f"User ID: {m.from_user.id}")
