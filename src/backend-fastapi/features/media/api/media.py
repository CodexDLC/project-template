...
from src.backend_fastapi.features.media.schemas.media import ImageRead
...
from src.backend_fastapi.dependencies.media import get_media_service
...
async def get_file(
    ...
    """
    # Use public logic method to resolve path
