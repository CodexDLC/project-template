...
# Schema isolation: FastAPI uses its own schema (default: fastapi_app).
# This allows sharing one DB (e.g. Neon) with Django/Bot
...
__all__ = ["Base", "get_db", "create_db_tables", "async_engine"]
